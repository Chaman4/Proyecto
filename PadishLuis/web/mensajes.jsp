<%-- 
    Document   : mensajes
    Created on : 5/10/2018, 08:13:15 AM
    Author     : Luigi
--%>
...
<a href="#" class="dropbtn">Metodos de envio</a>
  ...
  <div class="w3-bar w3-light w3-card" style="background-color: #3B929E; ">
    ...
    <a href="modificarperfil.jsp" class="w3-bar-item w3-button" id="loginform"><i class="fa fa-user-circle" aria-hidden="true"></i>  PERFIL</a>
    ...
    <a href="Chat.jsp" class="w3-bar-item w3-button"><i class="fa fa-comments" aria-hidden="true"></i> CHAT</a>
        <a href="cerrarsesion" class="w3-bar-item w3-button"><i class="fa fa-sign-out" aria-hidden="true"></i> CERRAR SESION</a>
    </div>
