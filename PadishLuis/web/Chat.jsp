<%-- 
    Document   : Chat
    Created on : 5/10/2018, 06:19:16 AM
    Author     : Luigi
--%>
            ...
            <table class="table table-bordered" id="tab">
                <tr id="th">
                    ...
                    <th class="text-center" >chat</th>
                        ...
                        <tr>
                            <br>
                            <td class="text-center"><i class="fa fa-user" aria-hidden="true"></i>felipe</td>
                            
                            <td class="text-center">
                                <button onclick="location.href='mensajes.jsp?id=333'" class="button "/><span>CHATEAR</span>  </button>
