...
<div class="jumbotron">
  ...
  <ul class="pagination justify-content-end">
      ...
      if (repeticiones !=0) {
              %>
      <li class="page-item">
      <a class="page-link" href="sesioniniciada.jsp?pag=<%=(repeticiones-1)%>" tabindex="-1">Anterior</a>
    </li>
      <%
          }
      %>
    ...
    %>
    <li class="page-item"><a class="page-link" href="sesioniniciada.jsp?pag=<%=(i)%>"><%=(i+1)%></a></li>
    <%   
        }
if (menus != (repeticiones+1)) {
    ...
    <li class="page-item">
      <a class="page-link" href="sesioniniciada.jsp?pag=<%=(repeticiones+1)%>">Siguiente</a>
    </li>
